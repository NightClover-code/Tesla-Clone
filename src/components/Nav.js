  ...
  return (
    <NavContainer className="nav-container">
      <NavBar>
        ...
        <Products>
          <Product>
            <ItemName href="#">Model S</ItemName>
          </Product>
          <Product>
            <ItemName href="#">Model 3</ItemName>
          </Product>
          <Product>
            <ItemName href="#">Model X</ItemName>
          </Product>
          <Product>
            <ItemName href="#">Model Y</ItemName>
          </Product>
          <Product>
            <ItemName href="#">Solar Roof</ItemName>
          </Product>
          <Product>
            <ItemName href="#">Solar Panels</ItemName>
          </Product>
        </Products>
        <Commerce>
          <Shop>
